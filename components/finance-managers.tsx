     ...
     <td>
       <div className="f-proposal-action-stack">
         ...
         {x.status==='WON'&&<div className="f-proposal-next-step">
           ...
           {activePO?.status==='RECEIVED'&&canFinance(role)&&<a className="f-btn primary" href="/customer-pos">Finance check</a>}
           {activePO?.status==='VERIFIED'&&!project&&canFinance(role)&&<a className="f-btn primary" href={'/projects?customerPoId='+activePO.id}>Buat Project</a>}
 ...
 return <div className="f-content f-domain-page">
   ...
   <Card className="f-domain-card">
     ...
     <div style={{overflowX:'auto'}}>
       <table className="f-table f-responsive-table f-invoice-table">
