...
export function ProjectsManager({role}:{role:string}){
  ...
  return <div className="f-content">
    ...
    <SideDrawer
      className="f-full-workspace project-create-workspace"
      open={drawerOpen}
      onClose={closeCreate}
