...
export default async function ClientsPage(){
 ...
 const clients=await prisma.clientVendor.findMany({where:{workspaceId:context.workspace.id},orderBy:{name:'asc'},select:{id:true,name:true,type:true,category:true,offerings:true,email:true,phone:true,picName:true,address:true,npwp:true,isActive:true,createdAt:true,updatedAt:true}})
