...
$('#userMenuBtn').addEventListener('click',(event)=>{ if(window.__FINORA_MANAGED_USER_MENU__) return; event.preventDefault(); toast('Profil','Menu profil akan tersedia melalui Finora session menu.'); });
